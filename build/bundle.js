...
/***/ function(module, exports, __webpack_require__) {
	...
	var _chartJs = __webpack_require__(3);
	...
	var _reducersReducers = __webpack_require__(15);
	...
	*/
	...
	var rootReducer = (0, _redux.combineReducers)({
	  ...
	  sweeps: _reducersReducers.sweepsReducer
	});
	...
	_riot2['default'].mount('app', {
	  ...
	  fetchSubmissions: _actionsActions.fetchSubmissions,
	  fetchSweeps: _actionsActions.fetchSweeps,
	  addSubmission: _actionsActions.addSubmission,
	  addSweep: _actionsActions.addSweep,
	  deleteSubmission: _actionsActions.deleteSubmission,
	  deleteSweep: _actionsActions.deleteSweep
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function(){
		...
		var each = helpers.each = function(loopable,callback,self){
			...
			amd = helpers.amd = ("function" == 'function' && __webpack_require__(2)),
			//-- Math methods
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _utilsWarning = __webpack_require__(9);
...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	exports.sweepsReducer = sweepsReducer;
	...
	function submissionReducer(state, action) {
	  ...
	  switch (action.type) {
	    case _actionsActions.RECEIVE_SUBMISSIONS:
	      return Object.assign({}, state, {
	        items: action.data
	      });
	    case _actionsActions.SUBMISSION_ADDED:
	      return Object.assign({}, state, {
	        items: [].concat(_toConsumableArray(state.items), [action.data])
	      });
	    case _actionsActions.SUBMISSION_DELETED:
	      return Object.assign({}, state, {
	...
	function sweepsReducer(state, action) {
	  ...
	  switch (action.type) {
	    case _actionsActions.RECEIVE_SWEEPS:
	      return Object.assign({}, state, {
	        items: action.data
	      });
	    case _actionsActions.SWEEP_ADDED:
	      return Object.assign({}, state, {
	        items: [].concat(_toConsumableArray(state.items), [action.data])
	      });
	    case _actionsActions.SWEEP_DELETED:
	      return Object.assign({}, state, {
	        items: [].concat(_toConsumableArray(state.items.slice(0, action.index)), _toConsumableArray(state.items.slice(action.index + 1)))
	      });
	    default:
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.fetchSweeps = fetchSweeps;
	exports.addSweep = addSweep;
	...
	* @name actions
	*/
	var SWEEP_ADDED = 'SWEEP_ADDED';
	exports.SWEEP_ADDED = SWEEP_ADDED;
	var SUBMISSION_ADDED = 'SUBMISSION_ADDED';
	exports.SUBMISSION_ADDED = SUBMISSION_ADDED;
	var SUBMISSION_DELETED = 'SUBMISSION_DELETED';
	exports.SUBMISSION_DELETED = SUBMISSION_DELETED;
	var RECEIVE_SUBMISSIONS = 'RECEIVE_SUBMISSIONS';
	exports.RECEIVE_SUBMISSIONS = RECEIVE_SUBMISSIONS;
	var RECEIVE_SWEEPS = 'RECEIVE_SWEEPS';
	exports.RECEIVE_SWEEPS = RECEIVE_SWEEPS;
	var SWEEP_DELETED = 'SWEEP_DELETED';

	exports.SWEEP_DELETED = SWEEP_DELETED;
	/**
	...
	*/
	...
	function fetchSubmissions() {
	  return function (dispatch, getState) {
	    return _axios2['default'].get('http://localhost:3000/submissions').then(function (response) {
	...
	function addSubmission(submissionName) {
	  return function (dispatch, getState) {
	    _axios2['default'].post('http://localhost:3000/submissions', {
	      name: submissionName
	...
	function deleteSubmission(id, index) {
	  return function (dispatch, getState) {
	    _axios2['default']['delete']('http://localhost:3000/submissions/' + id).then(function (response) {
	...
	function fetchSweeps() {
	  return function (dispatch, getState) {
	    return (0, _isomorphicFetch2['default'])('http://localhost:3000/sweeps').then(function (response) {
	      return response.json();
	    }).then(function (json) {
	      return dispatch(receiveSweeps(json));
	    });
	  };
	}
	...
	function addSweep(sweepName) {
	  return function (dispatch, getState) {
	    _axios2['default'].post('http://localhost:3000/sweeps', {
	      name: sweepName
	    }).then(function (response) {
	...
	function deleteSweep(id, index) {
	  return function (dispatch, getState) {
	    _axios2['default']['delete']('http://localhost:3000/sweeps/' + id).then(function (response) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var btoa = window.btoa || __webpack_require__(27);
...
/***/ function(module, exports, __webpack_require__) {
	...
	riot.tag2('line-graph', '<div style="max-width: 600px; margin: 0 auto"> <canvas id="chart"></canvas> </div>', '', '', function (opts) {
	  var self = this;
	  var Chart = self.opts.chart;
...
/***/ function(module, exports, __webpack_require__) {
	...
	riot.tag2('radar-graph', '<div style="max-width: 600px; margin: 0 auto"> <canvas id="radarChart"></canvas> </div>', '', '', function (opts) {
	  var self = this;
	  var Chart = self.opts.chart;
...
/***/ function(module, exports, __webpack_require__) {
	...
	riot.tag2('app', '<h2>Analytics</h2> <hr> <h4>Subs</h4> <submission-list submissions="{state.submissions.items}" deletesubmission="{opts.deleteSubmission}" store="{opts.store}"> </submission-list> <h4>Sweeps</h4> <sweep-list sweeps="{state.sweeps.items}" deletesweep="{opts.deleteSweep}" store="{opts.store}"> </sweep-list> <submission-form addsubmission="{handleNewSubmission}"> </submission-form> <sweep-form addsweep="{handleNewSweep}"> </sweep-form>', '', '', function (opts) {
	  var self = this;
	  var store = opts.store;

	  self.handleNewSubmission = function (submissionName) {
	    store.dispatch(opts.addSubmission(submissionName));
	  };

	  self.handleNewSweep = function (sweepName) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	riot.tag2('submission-list', '<ul> <li each="{opts.submissions}">{name} <span onclick="{deleteItem}">x</span></li> </ul>', 'submission-list span,[riot-tag="submission-list"] span { cursor: pointer; }', '', function (opts) {
	  var self = this;
	  var store = opts.store;

	  self.deleteItem = function (e) {
	    var id = e.item.id;
	    var index = self.opts.submissions.indexOf(e.item);
...
/***/ function(module, exports, __webpack_require__) {
	...
	riot.tag2('sweep-list', '<ul> <li each="{opts.sweeps}">{name} <span onclick="{handleDelete}">x</span></li> </ul>', 'sweep-list span,[riot-tag="sweep-list"] span { cursor: pointer; }', '', function (opts) {
	  var self = this;
	  var store = opts.store;

	  self.handleDelete = function (e) {
	    var id = e.item.id;
	    var index = self.opts.sweeps.indexOf(e.item);
...
/***/ function(module, exports, __webpack_require__) {
	...
	riot.tag2('submission-form', '<h4>Add a new submission</h4> <form onsubmit="{handleSubmit}"> <input type="text" name="newSub"> <button type="submit">Submit</button> </form>', '', '', function (opts) {
	  var self = this;
...
/***/ function(module, exports, __webpack_require__) {
	...
	riot.tag2('sweep-form', '<h4>Add Sweep</h4> <form onsubmit="{handleSubmit}"> <input type="text" name="newSweep"> <button type="submit">Submit</button> </form>', '', '', function (opts) {
	  var self = this;
